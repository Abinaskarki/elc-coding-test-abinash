...
## TEST COMPLETED BY ABINASH KARKI - UPDATED CODE JS LIST

/components => Product.js & ProductList.js
/sass => \_product.scss & \_productlist.scss

## HOW TO RUN

1. Run `npm install` to install all packages
2. Run `npm run servers` to run the project which will open localhost:3030 on default browser
3. Search for the items and view items change by each character you type
